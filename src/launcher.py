...
if __name__ == '__main__':
    ...
    from program_step02_identify_variables import entry as autostk_var_guesser
    from program_step03_prepare_patch import entry as autostk_patch_generate
    from program_step04_write_template import templater as autostk_templates
...
def call_autostk_identify_variables_program():
    return autostk_var_guesser.entry_point({'arglist_strict':False})

def call_autostk_prepare_patch_program():
...
def call_autostk_write_template_program():
...
run_programs = {
    ...
    'mdd-autostacking-pick-variables': call_autostk_identify_variables_program, # to be renamed to mdd-autostk-identify-variables
    'mdd-autostacking-prepare-patch': call_autostk_prepare_patch_program, # to be renamed to mdd-autostk-prepare-patch
    'mdd-patch': call_mdd_patch_program,
    'mdd-autostk-text-utility': call_autostk_write_template_program, # to be renamed to mdd-autostk-write-template
