...
# def generate_patch_stk(patch_specs,mdd_data,config):
#     return None

def generate_patch_scripts_mdata(mdd_data,patch,config):
    t = datetime.now()
    questions = mdd_data
    result = """
' auto-generated code
...
def generate_patch_scripts_edits(mdd_data,patch,config):
    t = datetime.now()
    questions = mdd_data
    result = """
' auto-generated code
...
def entry_point(runscript_config={}):
    ...
    if action=='generate-for-stk':
        ...
        result = generate_patch_scripts_mdata(mdd_data,patch_specs,config)
    elif action=='generate-scripts-edits':
        result = generate_patch_scripts_edits(mdd_data,patch_specs,config)
